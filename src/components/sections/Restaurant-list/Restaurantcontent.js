                                                        ...
                                                        <tr key={i}>
                                                            ...
                                                            <td>
                                                                <ul className="ms-star-rating rating-fill rating-circle ratings-new">
                                                                    <li className="ms-rating-item" onClick={addstars}> <i className="material-icons">star</i> </li>
                                                                    <li className="ms-rating-item rated"  onClick={addstars}> <i className="material-icons">star</i> </li>
                                                                    <li className="ms-rating-item rated"  onClick={addstars}> <i className="material-icons">star</i> </li>
                                                                    <li className="ms-rating-item rated"  onClick={addstars}> <i className="material-icons">star</i> </li>
                                                                    <li className="ms-rating-item rated"  onClick={addstars}> <i className="material-icons">star</i> </li>
                                                                </ul>
